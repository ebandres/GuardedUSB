...
_lr_productions = [
  ...
  ('body -> sentence body','body',2,'p_body','parser.py',40),
  ('body -> gfor body','body',2,'p_body','parser.py',41),
  ('body -> read body','body',2,'p_body','parser.py',42),
  ('body -> gdo body','body',2,'p_body','parser.py',43),
  ('body -> gif body','body',2,'p_body','parser.py',44),
  ('body -> empty','body',1,'p_body','parser.py',45),
  ('start -> declaration start','start',2,'p_start','parser.py',49),
  ('start -> body','start',1,'p_start','parser.py',50),
  ('empty -> <empty>','empty',0,'p_empty','parser.py',55),
  ('declaration -> TkId TkTwoPoints tipo TkSemiColon','declaration',4,'p_declaration','parser.py',59),
  ('declaration -> TkId TkComma listaid TkTwoPoints tipo TkSemiColon','declaration',6,'p_declaration','parser.py',60),
  ('listaid -> TkId TkComma listaid','listaid',3,'p_listid','parser.py',67),
  ('listaid -> TkId','listaid',1,'p_listid','parser.py',68),
  ('tipo -> TkInt','tipo',1,'p_tipo','parser.py',75),
  ('tipo -> TkArray TkOBracket TkNum TkSoForth TkNum TkCBracket','tipo',6,'p_tipo','parser.py',76),
  ('assign -> TkId TkAsig expression','assign',3,'p_assign_expr','parser.py',79),
  ('assign -> TkId TkAsig strexp','assign',3,'p_assign_str','parser.py',85),
  ('assign -> TkId TkAsig array','assign',3,'p_assign_arr','parser.py',91),
  ('array -> TkOBracket inarray TkCBracket','array',3,'p_array','parser.py',97),
  ('array -> TkOBracket TkNum TkSoForth TkNum TkCBracket','array',5,'p_array','parser.py',98),
  ('inarray -> TkNum TkComma inarray','inarray',3,'p_iarray','parser.py',101),
  ('inarray -> TkNum','inarray',1,'p_iarray','parser.py',102),
  ('strexp -> TkString TkConcat strexp','strexp',3,'p_expression_str','parser.py',105),
  ('strexp -> TkString','strexp',1,'p_expression_str','parser.py',106),
  ('expression -> expression TkPlus expression','expression',3,'p_expression_bin','parser.py',110),
  ('expression -> expression TkMinus expression','expression',3,'p_expression_bin','parser.py',111),
  ('expression -> expression TkMult expression','expression',3,'p_expression_bin','parser.py',112),
  ('expression -> expression TkDiv expression','expression',3,'p_expression_bin','parser.py',113),
  ('expression -> expression TkMod expression','expression',3,'p_expression_bin','parser.py',114),
  ('expression -> TkOpenPar expression TkClosePar','expression',3,'p_expression_group','parser.py',136),
  ('expression -> TkSize TkOpenPar TkId TkClosePar','expression',4,'p_expression_fun','parser.py',141),
  ('expression -> TkMax TkOpenPar TkId TkClosePar','expression',4,'p_expression_fun','parser.py',142),
  ('expression -> TkMin TkOpenPar TkId TkClosePar','expression',4,'p_expression_fun','parser.py',143),
  ('expression -> TkAtoi TkOpenPar TkId TkClosePar','expression',4,'p_expression_fun','parser.py',144),
  ('expression -> TkNum','expression',1,'p_expression_number','parser.py',149),
  ('expression -> TkId','expression',1,'p_expression_id','parser.py',155),
  ('boolean -> expression TkLess expression','boolean',3,'p_boolean_exp','parser.py',165),
  ('boolean -> expression TkLeq expression','boolean',3,'p_boolean_exp','parser.py',166),
  ('boolean -> expression TkGeq expression','boolean',3,'p_boolean_exp','parser.py',167),
  ('boolean -> expression TkGreater expression','boolean',3,'p_boolean_exp','parser.py',168),
  ('boolean -> boolean TkOr boolean','boolean',3,'p_boolean_exp','parser.py',169),
  ('boolean -> boolean TkAnd boolean','boolean',3,'p_boolean_exp','parser.py',170),
  ('boolean -> expression TkEqual expression','boolean',3,'p_boolean_exp','parser.py',171),
  ('boolean -> expression TkEqual boolean','boolean',3,'p_boolean_exp','parser.py',172),
  ('boolean -> boolean TkEqual expression','boolean',3,'p_boolean_exp','parser.py',173),
  ('boolean -> boolean TkEqual boolean','boolean',3,'p_boolean_exp','parser.py',174),
  ('boolean -> expression TkNEqual expression','boolean',3,'p_boolean_exp','parser.py',175),
  ('boolean -> expression TkNEqual boolean','boolean',3,'p_boolean_exp','parser.py',176),
  ('boolean -> boolean TkNEqual expression','boolean',3,'p_boolean_exp','parser.py',177),
  ('boolean -> boolean TkNEqual boolean','boolean',3,'p_boolean_exp','parser.py',178),
  ('boolean -> TkOpenPar boolean TkClosePar','boolean',3,'p_boolean_group','parser.py',207),
  ('boolean -> TkTrue','boolean',1,'p_boolean_true','parser.py',213),
  ('boolean -> TkFalse','boolean',1,'p_boolean_false','parser.py',219),
  ('boolean -> TkNot boolean','boolean',2,'p_boolean_not','parser.py',226),
  ('read -> TkRead TkId TkSemiColon','read',3,'p_read','parser.py',230),
  ('gfor -> TkFor TkId TkIn expression TkTo expression TkArrow block TkRof TkSemiColon','gfor',10,'p_cycle_for','parser.py',236),
  ('gdo -> TkDo boolean TkArrow block TkOd TkSemiColon','gdo',6,'p_cycle_do','parser.py',241),
  ('gif -> TkIf boolean TkArrow unique guard TkFi TkSemiColon','gif',7,'p_if','parser.py',245),
  ('gif -> TkIf boolean TkArrow block guard TkFi TkSemiColon','gif',7,'p_if','parser.py',246),
  ('sentence -> assign TkSemiColon','sentence',2,'p_sentence','parser.py',250),
  ('sentence -> gprint TkSemiColon','sentence',2,'p_sentence','parser.py',251),
  ('sentence -> gprintln TkSemiColon','sentence',2,'p_sentence','parser.py',252),
  ('unique -> assign','unique',1,'p_unique','parser.py',257),
  ('unique -> gprint','unique',1,'p_unique','parser.py',258),
  ('unique -> gprintln','unique',1,'p_unique','parser.py',259),
  ('guard -> TkGuard boolean TkArrow unique guard','guard',5,'p_guard','parser.py',263),
  ('guard -> TkGuard boolean TkArrow block guard','guard',5,'p_guard','parser.py',264),
  ('guard -> empty','guard',1,'p_guard','parser.py',265),
  ('gprint -> TkPrint strprint','gprint',2,'p_print','parser.py',270),
  ('gprintln -> TkPrintln strprint','gprintln',2,'p_println','parser.py',274),
  ('strprint -> TkString TkConcat strprint','strprint',3,'p_strprint','parser.py',278),
  ('strprint -> TkId TkConcat strprint','strprint',3,'p_strprint','parser.py',279),
  ('strprint -> TkString','strprint',1,'p_strprint','parser.py',280),
  ('strprint -> TkId','strprint',1,'p_strprint','parser.py',281),
]
